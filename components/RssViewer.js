...
import { Search, SortAsc, SortDesc, Tag, ExternalLink, Mail } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto px-2 sm:px-4 py-8 bg-gray-100">
      ...
      <div className="space-y-4">
        {entries.map((entry) => (
          <div key={entry.id} className="bg-white rounded-lg shadow-md overflow-hidden transform transition duration-400 ease-in-out hover:-translate-y-2 hover:scale-[1.01] hover:shadow-xl">
            <div className="p-4">
